  ...
  <div>
    ...
    <div class="content" v-if="loaded">
      ...
      <p>
        <editor
          v-model="pageText"
          api-key="gxzi6f7gzgwnljd61r5piw87mdbhkehdocf238nb40ye85rt"
          :init="{
            toolbar1: ' fontsizeselect  styleselect|  bold italic  strikethrough | link  ltr rtl| formatselect',
            plugins: [ 'link image imagetools table spellchecker'],
            contextmenu:'link image imagetools table spellchecker', 
            content_css: ['public/css/AU-myfriends.css'],
