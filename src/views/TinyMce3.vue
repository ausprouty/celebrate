<template>
  <div>
    ...
    <div class="content" v-if="loaded">
      ...
      <p>
        <tinymce v-model="pageText" api-key="gxzi6f7gzgwnljd61r5piw87mdbhkehdocf238nb40ye85rt"></tinymce>
         <div class="well" v-html="pageText" style="margin-top: 30px;"></div>
      </p>
      <script type="text/x-template" id="tinymce-template">
    <div>
      <textarea
        rows="10"
		v-bind:value="pageText"
      ></textarea>
    </div>
  </script>
